...
class Chuncai {
    ...
    init() {
        ...
        drag(this.ele.children(".chuncai-face"), this.ele, this.savePos.bind(this)); //pc端绑定拖拽
        drag2(this.ele.children(".chuncai-face"), this.ele, this.savePos.bind(this)); //移动端绑定拖拽
